...
var advancedCMDs = true;
var advancedSSID = true;



function toggleAdvanced(){
    advancedCMDs = !advancedCMDs;
    if(advancedCMDs){
...
function chk(state){
    ...
    const btneasy = document.getElementById("connectEasy");
    const menu = document.getElementById("gear-icon");
    const ip = document.getElementById("ip");
    const name = document.getElementById("robotName");
    if(state == true){
        displayMessage("eBrain Connected");
        btneasy.style.backgroundColor = '#ddffdd';
        menu.src = '/tools/eBrain/robotConnected.png';
        ...
        btneasy.style.backgroundColor = '#ffdddd';
        menu.src = '/tools/eBrain/robot.png';
...
function showMeetings(){
    document.getElementById('meetingsButton').style.display='block';
}