        ...
        async function USBconnect() {
          ...
          tempButton.style.border = "6px solid #0F0";
          ...
          //document.getElementById('connectTemp').click();
      ...
      function connect(url) {
          ...
          socket.onopen = function () {
              ...
              if (eb) {
                eb.connected = true; // signal disconnection to other code.
              }
          };
      ...
      window.addEventListener("message", (event) => {
                ...
                if(event.data.cmd == "usb"){
                    ...
                    closeWS();
                }else if (event.data.cmd == "chk"){
                    var msg = {'msg':eb.chkConnection(),'id':event.data.id};
